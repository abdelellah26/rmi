...
public interface InterfaceClient extends Remote{
    void getM() throws RemoteException;
    ...
    String getName()throws RemoteException;
     ...
     //cette fonction pour recuperer email des clients connectes
    String getEmail()throws RemoteException;
    
    //cette fonction pour recuperer le password des clients connectes 
